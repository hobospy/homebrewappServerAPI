...
namespace homebrewappServerAPI.Tests
{
    public class RecipeServiceTests
    {
        ...
        public async Task ListAsync_ByDefault_CallsListAsyncOnce()
        {
            ...
            var mockTimerRepository = new Mock<ITimerRepository>();
            var mockRecipeRepository = new Mock<IRecipeRepository>();
            mockRecipeRepository.Setup(m => m.ListAsync());
            var recipeService = new RecipeService(mockRecipeRepository.Object, mockIngredientRepository.Object, mockTimerRepository.Object, mockRecipeStepRepository.Object, mockUnitOfWork.Object);
